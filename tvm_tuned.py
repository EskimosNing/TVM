...
parser.add_argument('-m', '--model', type=str, default='./models/vgg19.onnx')
#parser.add_argument('-l', '--log', type=str, default='./tvm-log/1thread-log/x86/onnx/1batch/x86_onnx_1batch_resnet18.log')
