...
model_path = os.path.expanduser("/workspace/autotvm-cuda/tvm-data/onnx/resnet50-v2-7.onnx")
onnx_model = onnx.load(model_path)

print("onnx model load finished")
...
img_path = os.path.expanduser("/workspace/autotvm-cuda/tvm-data/data/imagenet_cat.png")
...
labels_path = os.path.expanduser("/workspace/autotvm-cuda/tvm-data/data/synset.txt")
...
tuning_option = {
    ...
    "best_tuning_records": "best_resnet-50-v2-autotuning.json",
}
...
for i, task in enumerate(tasks):
    ...
    autotvm.record.pick_best(tuning_option["tuning_records"], tuning_option["best_tuning_records"])
